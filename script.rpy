    ...
    init python:
        ...
        class GameDisplayable(renpy.Displayable):
            ...
            def __init__(self):
                ...
                self._1_image = FlyView(View((95, 150), Image("1_photo(1).jpg")), speed=10, box_view=self._box_view)
                self._2_image = FlyView(View((490, 150), Image("2_photo(1).jpg")), speed=10, box_view=self._box_view)
                self._3_image = FlyView(View((885, 150), Image("3_photo(1).jpg")), speed=10, box_view=self._box_view)
                self._4_image = FlyView(View((1375, 150), Image("4_photo(1).jpg")), speed=10, box_view=self._box_view)
